...
**系统通过串口与上位机实时通信，支持 JSON 报文格式上报全部传感器数据（温度、湿度、PM2.5、风速、光照、电压电流等），同时可接收上位机下发的远程控制指令，实现灯光调节、卷帘门控制、继电器操作等功能。配合云端上位机，可实现远程监控与远程控制。**

**集成无人机机巢，支持机巢舱门开关、升降台（推杆+平台）控制，可通过上位机远程操控无人机起降及巢内设备动作。**

**上报数据样例 (USART2, 115200bps):**
